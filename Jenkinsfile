...
//          bat' liquibase status --url="jdbc:mysql://localhost:3306/inventory" --changeLogFile=my_app-wrapper.xml --username="testuser" --password="password"'
         bat' liquibase status --url="jdbc:mysql://localhost:3306/inventory" --changeLogFile=".//src//main//resources//db//changelog//db.changelog-master.yaml" --username="root" --password="Password@2021"'
      }
    }
    stage('Update') {
      steps {
...
//        bat 'liquibase update --url="jdbc:mysql://localhost:3306/inventory" --changeLogFile=my_app-wrapper.xml --username="testuser" --password="password"'
        bat' liquibase update --url="jdbc:mysql://localhost:3306/inventory" --changeLogFile=".//src//main//resources//db//changelog//db.changelog-master.yaml" --username="root" --password="Password@2021"'
      }
    }
  }
/*  post {
